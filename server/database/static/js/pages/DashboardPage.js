        ...
        <div class="dashboard-layout">
            ...
            <div class="mobile-header">
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <h2 style="font-size: 1.2rem; margin:0;">Smart Room</h2>
                </div>
            ...
            <aside class="sidebar glass-panel" id="sidebar">
                <div class="sidebar-header">
                    <img src="image/logo.png" alt="Smart Room Logo" style="width: 40px; height: 40px; border-radius: var(--radius-sm); object-fit: contain; cursor: pointer;" id="logo-btn">
                    <h2>Smart Room</h2>
                </div>
